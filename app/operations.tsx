...
export default function OperationsScreen() {
  ...
  const summaryQuery = trpc.operations.summary.useQuery(undefined, { enabled: Boolean(user && user.role !== "student"), retry: false, staleTime: 60_000 });
  const coursesQuery = trpc.operations.courses.useQuery(undefined, { enabled: Boolean(user && user.role !== "student"), retry: false, staleTime: 60_000 });
