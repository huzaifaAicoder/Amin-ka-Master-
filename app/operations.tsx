...
const EMPTY_SUMMARY = { students: 0, courses: 0, enrollments: 0, upcomingLiveClasses: 0 };
...
export default function OperationsScreen() {
  ...
  const learningOperationsQuery = trpc.operations.learningOperations.useQuery(undefined, { enabled: Boolean(user && user.role !== "student" && user.role !== "developer"), retry: false });
  const { refreshing, onRefresh } = usePanelRefresh([summaryQuery.refetch, coursesQuery.refetch, learningOperationsQuery.refetch]);
...
const styles = StyleSheet.create({
  ...
  loadingCourses: { color: COLORS.muted, fontSize: 13, marginTop: 10, textAlign: "center" },
