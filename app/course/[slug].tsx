...
import { Alert, ActivityIndicator, Linking, Platform, Pressable, ScrollView, StyleSheet, Text, useWindowDimensions, View } from "react-native";
...
export default function CourseDetailScreen() {
  ...
  const desktopLayout = Platform.OS === "web" && width >= 900;
  ...
  return (
    <ScreenContainer edges={["top", "bottom", "left", "right"]} className="px-5">
      <ScrollView contentContainerStyle={[styles.content, desktopLayout && styles.contentDesktop]} showsVerticalScrollIndicator={false}>
...
const styles = StyleSheet.create({
  content: { paddingTop: 10, paddingBottom: 34, width: "100%" }, contentDesktop: { maxWidth: 1180, alignSelf: "center" },
  ...
  heroRow: { gap: 12 }, heroRowDesktop: { flexDirection: "row", alignItems: "stretch" }, hero: { flex: 1, minHeight: 252, overflow: "hidden", borderRadius: 24, padding: 20, justifyContent: "flex-end", backgroundColor: COLORS.indigo }, purchaseCard: { gap: 12 }, purchaseCardDesktop: { width: 310, justifyContent: "center" },
  ...
  priceCard: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingVertical: 4 },
  ...
  bodyRow: { gap: 12 }, bodyRowDesktop: { flexDirection: "row", alignItems: "flex-start", gap: 22 }, mainColumn: { flex: 1, minWidth: 0 }, sideColumn: { width: "100%" }, sideColumnDesktop: { width: 294, position: "relative" }, sectionTitle: { color: COLORS.ink, fontWeight: "800", fontSize: 19, marginTop: 28, marginBottom: 10 },
