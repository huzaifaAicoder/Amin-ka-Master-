...
export default function CompassScreen() {
  ...
  const stop = () => { subscription.current?.remove(); subscription.current = null; setActive(false); };
  useEffect(() => () => stop(), []);
  const start = async () => {
