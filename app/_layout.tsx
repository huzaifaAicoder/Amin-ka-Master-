...
function AuthenticationGate({ children }: { children: React.ReactNode }) {
  ...
  const isStudentPortalRoute = rootSegment === "(tabs)" || rootSegment === "course" || rootSegment === "lesson" || rootSegment === "tests" || rootSegment === "test" || rootSegment === "test-history" || rootSegment === "live" || rootSegment === "notifications" || rootSegment === "sessions" || rootSegment === "study-coach";
  ...
  const studentFeaturePaused = Boolean(user?.role === "student" && (((rootSegment === "shorts" || segments[1] === "shorts") && (!flag("feature.shorts_enabled") || !studentFeature("shorts"))) || ((rootSegment === "downloads" || segments[1] === "downloads") && (!flag("feature.downloads_enabled") || !studentFeature("downloads"))) || ((rootSegment === "ask-ai" || rootSegment === "ai-quiz") && (!flag("feature.ai_doubt_enabled") || !studentFeature("ai_doubt") || (rootSegment === "ai-quiz" && (!flag("feature.ai_quiz_enabled") || !studentFeature("ai_quiz"))))) || (rootSegment === "study-coach" && (!flag("feature.study_coach_enabled") || !studentFeature("study_coach"))) || ((rootSegment === "tests" || rootSegment === "test" || rootSegment === "test-history") && (!flag("feature.assessments_enabled") || !studentFeature("assessments"))) || ((rootSegment === "live" || rootSegment === "sessions") && (!flag("feature.live_classes_enabled") || !studentFeature("live_classes"))) || (rootSegment === "course" && (!flag("feature.courses_enabled") || !studentFeature("courses")))));
  const staffFeaturePaused = Boolean((user?.role === "teacher" || user?.role === "admin" || user?.role === "super_admin") && rootSegment === "operations" && segments[1] === "learning-ops" && !flag("feature.learning_operations_enabled"));
