...
export default function AskAiScreen() {
  ...
  const waitingStage = waitingSeconds < 5 ? "Reading your question" : waitingSeconds < 13 ? "Preparing a clear answer" : "Still working — this may take a little longer";
