...
const tools = [
  ...
  { icon: "map" as const, title: "Digital Map & Bhumi Records", body: "Open reviewed official government land-record and available digital-map portals inside the app.", route: "/toolkit/land-records" },
