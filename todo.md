...
- [ ] Run the authenticated Android and iOS four-role QA runbook against the refreshed preview, covering the restored Account route guard and native device flows, and record device-specific results without bypassing authentication.
