...
| Authentication | Seven-tap logo discovery feedback | Verified, build | The app logo has a native-driver scale cue and seven-dot visual sequence that resets after three seconds. It is visual-only and does not authenticate or expose a privileged route; complete a physical-device touch feedback walkthrough. |
